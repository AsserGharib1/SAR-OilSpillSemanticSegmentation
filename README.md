...
Public **Sentinel-1 SAR Oil Spill dataset** (Trujillo-Acatitla, Tuxpan-Vargas, Ovando-Vázquez & Monterrubio-Martínez, CC-BY 4.0). Parts I and II were used for training/validation and Part III as the held-out test set:
